...
class CompanionPairingVerifier:
    ...
    async def verify_credentials(self):
        ...
        msg = {
            "_pd": tlv8.write_tlv({tlv8.TLV_SEQ_NO: b"\x01", tlv8.TLV_PUBLIC_KEY: public_key}),
            "_auTy": 4,
            }
        ...
        msg = {
            "_pd": tlv8.write_tlv({tlv8.TLV_SEQ_NO: b"\x03", tlv8.TLV_ENCRYPTED_DATA: encrypted_data}),
            }
