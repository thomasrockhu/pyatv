...
from pyatv.conf import AppleTV, DmapService, MrpService, AirPlayService, CompanionService
...
class GlobalCommands:
    ...
    async def pair(self):
        ...
        apple_tv.set_credentials(const.Protocol.Companion, self.args.companion_credentials)
